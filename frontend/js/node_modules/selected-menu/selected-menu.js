...
SelectedMenu.prototype.renderNode = function(data, gui) {
    showNodeMenu.call(
        this,
        this.container,
        this.inputs,
...
SelectedMenu.prototype.renderLink = function(link) {
    this.showConditions = showLinkMenu.call(
        this,
        this.container,
        this.inputs,
        this.buttons,
...
SelectedMenu.prototype.hide = function() {
    ...
    this.iconGroups.forEach(function(iconGroup) {
        iconGroup.hide();
    });

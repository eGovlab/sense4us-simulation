...
MenuItem.prototype = {
    ...
    addEditableDropdown: function(label, values, newCallback, editCallback, deleteCallback, changeCallback) {
        ...
        dropdown.select.root.style.padding = '4px 8px';
        ...
        input.input.root.style.padding = '4px 8px';
        ...
        input.input.setBackground(Colors.dropdownEdit);
        input.input.root.style.color = '#fafafa';

        input.input.setWidth('100%');
        ...
        var createButton = function() {
            ...
            //button.root.style['text-shadow'] = '0 0px 4px rgba(0,0,0,0.55)';
            button.root.style.color          = '#fafafa';
        ...
        editButton.setBackground(Colors.dropdownEdit);

        var deleteButton = createButton();
        deleteButton.setBackground(Colors.dropdownDelete);

        var newButton    = createButton();
        newButton.setBackground(Colors.dropdownNew);
    ...
    addTimeRow: function(step, value, node, stepCallback, valueCallback, rowDeleted) {
        ...
        deleteButton.setBackground(Colors.warning);
    ...
    addDropdown: function(label, values, callback) {
        ...
        dropdown.root.style.padding        = '16px 8px';
    ...
    addInput: function(label) {
        ...
        input.root.style.padding = '8px 8px';
        input.root.style['text-align'] = 'center';

...
function createPopup(config) {
    ...
    popup.root.style['-webkit-box-shadow'] = shadow;
    popup.root.style['-moz-box-shadow']    = shadow;
    popup.root.style['box-shadow']         = shadow;
    
    popup.root.style['border-radius']      = '4px';
    popup.root.style.padding               = '8px 16px';
